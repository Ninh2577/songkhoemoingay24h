...
function normalizeArticle(raw) {
    ...
    // Fallbacks
    const title = raw.tieuDe || 'Bài Viết';
    ...
    // Image and Author
    const coverImage = raw.anhBia?.url || null; // Will fallback to default in SEO builder
    const authorName = raw.tacGia?.ten || 'Ban Biên Tập';
